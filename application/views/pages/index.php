        ...
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top: 35px; color: #86817D">
                ...
                <div class="jumbotron" style="background-color: #1B1D1D;">
                    ...
                    <p class="lead">Esta é uma simples página apenas para treinar as habilidades do desenvolvimento web.
                        Estamos utilizando HTML5, Bootstrap 4, Framework CodeIgniter e PHP.</p>
                ...
                <div class="row clearfix" style="text-align: justify">
                    ...
                    <div class="col-md-3" style="margin-bottom: 20px;">
                        <div class="card personagem" style="background-color: #1B1D1D; color: #86817D">
                            <img class="card-img-top" src="assets/images/herois/<?= $heroi['nome_imagem'] ?>"
                                alt="Card image cap">
                            <div class="card-body">
